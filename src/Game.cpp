...
Game::Game() {
	m_TeamDatas.push_back( TeamData( glm::vec4( 1.0f, 0.0f, 0.0f, 1.0f ), new Human(), NR_OF_SNAKES_PER_TEAM ) );
	m_MainState		= new GameState( glm::uvec2( 40, 30 ), m_TeamDatas.size(), NR_OF_SNAKES_PER_TEAM, 12 );
}
